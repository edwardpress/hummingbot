...
class EunionOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self,
        ...
        super().__init__(EunionAPIOrderBookDataSource(trading_pairs), trading_pairs)
    ...
    def data_source(self) -> OrderBookTrackerDataSource:
        if not self._data_source:
            self._data_source = EunionAPIOrderBookDataSource(trading_pairs=self._trading_pairs)
        ...
        while True:
            try:
                ...
                if message.type is OrderBookMessageType.DIFF:
                    #  websocket messages contain the entire order book state so they should be treated as snapshots
